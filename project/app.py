...
.kpi-card {
    ...
    padding: 0.7rem 1rem; border-left: 4px solid #3b82f6;
...
/* param panel sticky — CSS handles z-index/position, JS handles background */
...
(function(){
  function run(){
    try{
      ...
      target.style.borderBottom='2px solid #334155';
